<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FondoMonetario.aspx.cs" Inherits="PruebaTecnicaO.FondoMonetario" %>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-11 col-xl-3">
        ...
        <div>
            Listado de Fondos Monetarios:
            <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataSourceID="SqlDS">
                <Columns>
                    <asp:BoundField DataField="Id" HeaderText="Id" InsertVisible="False" ReadOnly="True" SortExpression="Id" />
                    <asp:BoundField DataField="Descripcion" HeaderText="Descripcion" SortExpression="Descripcion" />
                </Columns>
            </asp:GridView>
            <asp:SqlDataSource ID="SqlDS" runat="server" ConnectionString="<%$ ConnectionStrings:infileConnectionString %>" SelectCommand="SELECT [Id], [Descripcion] FROM [FondoMonetario]"></asp:SqlDataSource>
        </div>
    </form>
